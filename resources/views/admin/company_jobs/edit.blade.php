            ...
            <div class="bg-white overflow-hidden p-10 shadow-sm sm:rounded-lg">
                ...
                <form method="POST" action="{{ route('admin.company_jobs.update', $companyJob) }} "
                    ...
                    <div>
                        ...
                        <x-text-input id="name" class="block mt-1 w-full" value="{{ $companyJob->name }}"
                    ...
                    <div class="mt-4">
                        ...
                        <select name="type" id="type"
                            ...
                            <option @selected($companyJob->type == 'Part-Time') value="Part-Time">Part-Time</option>
                            <option @selected($companyJob->type == 'Full-Time') value="Full-Time">Full-Time</option>
                        </select>
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="salary" class="block mt-1 w-full" value="{{ $companyJob->salary }}"
                            type="number" name="salary" required autofocus autocomplete="salary" />
                        <x-input-error :messages="$errors->get('salary')" class="mt-2" />
                    </div>

                    <div class="mt-4">
                        <x-input-label for="location" :value="__('location')" />
                        <x-text-input id="location" class="block mt-1 w-full" value="{{ $companyJob->location }}"
                    ...
                    <div class="mt-4">
                        ...
                        <select name="skill_level" id="skill_level"
                            ...
                            <option @selected($companyJob->type == 'Beginner') value="Beginner">Beginner</option>
                            <option @selected($companyJob->type == 'Intermediate') value="Intermediate">Intermediate</option>
                            <option @selected($companyJob->type == 'Expert') value="Expert">Expert</option>
                        </select>
                    ...
                    <div class="mt-4">
                        ...
                        <select name="category_id" id="category_id"
                            ...
                            @foreach ($categories as $category)
                                <option @selected($companyJob->category_id == $category->id) value="{{ $category->id }}">{{ $category->name }}
                                </option>
                            @endforeach
                        </select>
                        ...
                        <div class="flex flex-col gap-y-5">
                            ...
                            @foreach ($companyJob->responsibilities as $responsibility)
                                <input type="text" class="py-3 rounded-lg border-slate-300 border"
                                    placeholder="Write your responsibilities" value="{{ $responsibility->name }}"
                    ...
                    <div class="mt-4">
                        ...
                        <div class="flex flex-col gap-y-5">
                            ...
                            @foreach ($companyJob->qualifications as $qualification)
                                <input type="text" class="py-3 rounded-lg border-slate-300 border"
                                    placeholder="Write your qualifications" value="{{ $qualification->name }}"
                                    name="qualifications[]">
                            @endforeach
